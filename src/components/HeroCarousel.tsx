          ...
          >
            <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="mt-4 text-white/80">
                  {hero.subtitle || "Aile, iş ve ticaret hukukunda uzman ekibimizle yanınızdayız."}
                </p>
              ...
              <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-white/10 to-white/0 border border-white/20 flex items-center justify-center">
                <div className="w-5/6 h-5/6 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white/70">
                  Hero Görsel Alanı
                </div>
              </div>
            </div>
